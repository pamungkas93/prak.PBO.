...
public class FrmKategori1921743014Dhuta extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        ...
        ArrayList<Kategori1921743014Dhuta> list = new Kategori1921743014Dhuta().getAll();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Kategori1921743014Dhuta kat : list){
    ...
    public void cari(String keyword){
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1921743014Dhuta> list = new Kategori1921743014Dhuta().search(keyword);
        Object rowData[] = new Object[3];
     ...
     */
    public FrmKategori1921743014Dhuta() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1921743014Dhuta kat = new Kategori1921743014Dhuta().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmKategori1921743014Dhuta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1921743014Dhuta().setVisible(true);
            }
        });
    }

 ...
 * @author ASUS
 */
public class FrmBuku1921743014Dhuta extends javax.swing.JFrame {

    /**
     * Creates new form FrmBuku
     */
    public FrmBuku1921743014Dhuta() {
        initComponents();
        tampilkanData();
    ...
    public void tampilkanData() {
        ...
        ArrayList<Buku1921743014Dhuta> list = new Buku1921743014Dhuta().getAll();
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Kategori", "Judul", "Penulis", "Penerbit"};
        ArrayList<Buku1921743014Dhuta> list = new Buku1921743014Dhuta().search(keyword);
        Object rowData[] = new Object[5];
        
        tblBuku.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Buku1921743014Dhuta buku : list) {
    ...
    public void tampilkanCmbKategori () {
        cmbKategori.setModel(new DefaultComboBoxModel(new Kategori1921743014Dhuta().getAll().toArray()));
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        buku.setKategori((Kategori1921743014Dhuta)cmbKategori.getSelectedItem());
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku1921743014Dhuta buku = new Buku1921743014Dhuta().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuku1921743014Dhuta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuku1921743014Dhuta().setVisible(true);
            }
        });
    }
